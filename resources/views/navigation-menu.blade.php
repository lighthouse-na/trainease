<nav x-data="{ open: false }"
    class="bg-slate-900 text-white dark:bg-slate-900 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div x-data="window.themeSwitcher()" x-init="switchTheme()" @keydown.window.tab="switchOn = false"
                    ...
                    <label @click="$refs.switchButton.click(); $refs.switchButton.focus()" :id="$id('switch')"
                        :class="{ 'text-gray-400': switchOn, 'text-gray-400': !switchOn }" class="text-xs select-none">
                        Dark Mode
                    </label>
                </div>
                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 border border-gray-200 text-sm leading-4 font-medium rounded-md text-white bg-slate-900 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:bg-gray-50 dark:focus:bg-gray-700 active:bg-gray-50 dark:active:bg-gray-700 transition ease-in-out duration-150">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 border border-gray-200 bg-slate-900 text-sm leading-4 font-medium rounded-md text-white dark:text-gray-400  dark:bg-gray-800 hover:text-gray-200 dark:hover:text-gray-300   dark:focus:bg-gray-700 active:bg-gray-900 dark:active:bg-gray-700 transition ease-in-out duration-150">
