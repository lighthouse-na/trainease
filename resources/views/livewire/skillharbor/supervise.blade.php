    ...
    <x-skillharbor.layout heading="{{ __('Supervise') }}" subheading="{{ __('View and manage your staff skill assessments') }}">
        <div class="space-y-8">
            ...
            <div class="flex items-center justify-between px-6 py-4" data-slot="header">
                <div class="space-y-1 ">
                <h3 class="font-medium text-strong">{{ __('Current Assessments') }}</h3>
            ...
            <div class="divide-default bg-white shadow-xs-with-border divide-y rounded-lg" data-slot="content">
                @foreach([
