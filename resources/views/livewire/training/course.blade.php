<div class="flex h-screen w-full bg-gray-100 dark:bg-gray-900">
            ...
            <div class="border rounded-lg p-4 bg-gray-50 dark:bg-gray-700">
                ...
                @if ($enrollment->status === 'completed')
                    <div class="flex justify-between items-center mt-4">
                        <a class="bg-white border px-3 py-2 text-xs rounded-lg cursor-pointer hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200">
            ...
            <div class="mt-6">
                ...
                @forelse ($quizzes as $quiz)
                    <a href="#"
                        ...
                        {{ $quiz->id % 2 == 0 ? 'bg-green-50 border-green-200 text-green-700 dark:bg-green-900 dark:border-green-700 dark:text-green-200' : 'bg-white border-gray-200 text-gray-700 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200' }}">
                        <span class="flex justify-center items-center h-6 w-6 mr-3">
                            @if ($quiz->id % 2 == 0)
                                ✅
                            @else
    ...
    <!-- Main Content -->
    <div class="p-12 overflow-y-auto w-full transition-opacity opacity-0 animate-fade-in" wire:loading.class="opacity-0"
        wire:loading.class.remove="opacity-100" wire:target="loadNextMaterial,loadPreviousMaterial"
        id="contentContainer">
        ...
        @if ($content)
            ...
            <div class="flex justify-end my-12">
                <button wire:click="loadPreviousMaterial"
                    ...
                    Previous <x-fas-angle-left class="h-3 w-3"/>
                ...
                <button wire:click="loadNextMaterial"
                    ...
                    Next <x-fas-angle-right class="h-3 w-3"/>

                </button>

                @if ($content->id === $courseMaterials->last()->id)
                    <button wire:click="completeCourse" class="m-4 bg-green-500 text-white px-4 py-2 rounded-lg transition hover:bg-green-600">
                         Complete Course
                    </button>
                @endif
            </div>
