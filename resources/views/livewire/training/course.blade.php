                ...
                @if ($enrollment->status === 'completed')
                    <div class="flex justify-between mt-4">
                        ...
                        <div class="justify-end">
                            <a class="bg-white border text-xs rounded-lg p-2 mt-2 cursor-pointer">Download
                                Certificate</a>
        ...
        {{ in_array($material->id, $completedMaterials) ? 'bg-green-50 border-green-200 text-green-700' : 'bg-white border-gray-200 text-gray-700' }}"
                        ...
                        <span class="flex justify-center items-center h-6 w-6 mr-3">
                            ...
                            @elseif ($content->id === $material->id)
                                <x-fas-circle-notch class="h-4 w-4 text-blue-600" />
                            @else
        ...
        @if ($content)
            ...
            <div class="flex justify-end my-12">
                ...
                @if ($content->id === $courseMaterials->last()->id)
                    <button wire:click="completeCourse" class="m-4 bg-green-500 text-white px-4 py-2 rounded-lg">
                        Complete Course
                    </button>
                @endif
            </div>
