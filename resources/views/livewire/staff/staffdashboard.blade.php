...
<div class="grid grid-cols-4 gap-6">
    ...
    <div class="col-span-3 grid grid-cols-3 gap-6">
        @foreach ($stats as $stat)
            <div
                class="relative rounded-lg px-6 py-4 bg-zinc-50 dark:bg-zinc-700 {{ $loop->iteration > 1 ? 'max-md:hidden' : '' }} {{ $loop->iteration > 3 ? 'max-lg:hidden' : '' }}">
                            ...
                            @forelse ($enrollments as $enrollment)
                                <tr class="text-neutral-800 hover:bg-slate-100 dark:hover:bg-gray-800 cursor-pointer transition-colors"
                                    ...
                                    <td class="px-5 py-4 text-sm whitespace-nowrap text-center">
                                        <div>
                                            <div
                                                class="flex items-center justify-between text-xs font-semibold text-gray-500 dark:text-gray-100">
                                ...
                                <tr>
                                    <td colspan="4" class="px-5 py-10 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="mt-2 text-gray-500">Start your learning journey by enrolling in a
                                                course.</p>
